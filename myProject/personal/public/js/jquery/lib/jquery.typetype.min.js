jQuery.fn.extend({
    backspace: function(e, t) {
        ...
        this.each(function() {
            var t;
            return t = this,
            jQuery(t).queue(function() {
                var r, u;
                return r = t.tagName === "input".toUpperCase() || t.tagName === "textarea".toUpperCase() ? "value" : "innerHTML",
                (u = function(e) {
                    e ? (t[r] = t[r].slice(0, -1),
                    n.keypress.call(t),
                    setTimeout(function() {
                    ...
                    , Math.random() * n.t)) : (n.callback.call(t),
                    jQuery(t).dequeue())
                }
                )(e)
            }
    ...
    typetype: function(e, t) {
        ...
        this.each(function() {
            ...
            jQuery(t).queue(function() {
                var u, a, c, i;
                return a = t.tagName === "input".toUpperCase() || t.tagName === "textarea".toUpperCase() ? "value" : "innerHTML",
                u = function(e, n) {
                    e ? (t[a] += e[0],
                    r.keypress.call(t),
                    setTimeout(function() {
                ...
                (i = function(o) {
                    ...
                    ,
                    l = Math.random() / r.e,
                    .3 > l && e[o - 1] !== e[o] && e.length > o + 4 ? u(e.slice(o, o + 4), function() {
                        return c(4, s)
                    }
